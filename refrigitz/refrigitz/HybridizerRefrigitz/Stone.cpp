...
#include "Point.h
	...
	void Stone::InitializeInstanceFields()
	{
		color = 0;
		x = 0;
		y = 0;
	...
	int Pawn::move(Board *brd, int x2, int y2)
	{
	...
	int Pawn::playable(Board *brd, int x2, int y2)
	{
	...
	Knight::Knight(int c, int i, int j)
	{
		color = c;
		x = i;
		y = j;
	...
	int Knight::move(Board *brd, int x2, int y2)
	{
		int k = brd->getInfo(x2, y2);
		int v1 = x - x2;
		int v2 = y - y2;
	...
	int Knight::playable(Board *brd, int x2, int y2)
	{
		Point *p = brd->searchKing(color);
		King *king = new King(color,0,0);
		king->x = p->x;
	...
	Castle::Castle(int c, int i, int j)
	{
		color = c;
		x = i;
		y = j;
	...
	int Castle::move(Board *brd, int x2, int y2)
	{
		int k = brd->getInfo(x2, y2);
		int i;
		if (x == x2)
	...
	int Castle::playable(Board *brd, int x2, int y2)
	{
		Point *p = brd->searchKing(color);
		King *king = new King(color,0,0);
		king->x = p->x;
	...
	Bishop::Bishop(int c, int i, int j)
	{
		color = c;
		x = i;
		y = j;
	...
	int Bishop::move(Board *brd, int x2, int y2)
	{
		int k = brd->getInfo(x2,y2);
		int i = x2 - x;
		int j = y2 - y;
	...
	int Bishop::playable(Board *brd, int x2, int y2)
	{
		Point *p = brd->searchKing(color);
		King *king = new King(color,0,0);
		king->x = p->x;
	...
	int Queen::move(Board *brd, int x2, int y2)
	{
		int k = brd->getInfo(x2,y2);
		int i, j;
	...
	int Queen::playable(Board *brd, int x2, int y2)
	{
		Point *p = brd->searchKing(color);
		King *king = new King(color,0,0);
		king->x = p->x;
	...
	int King::move(Board *brd, int x2, int y2)
	{
		if (x2 < 0 || y2 < 0)
		{
			return 0;
	...
	int King::playable(Board *brd, int x2, int y2)
	{
		if (x2 < 0 || y2 < 0)
		{
			return 0;
